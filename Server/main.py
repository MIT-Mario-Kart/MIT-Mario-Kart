...
car3 = Car("CAR3", 2, "CAR_ID_3", ROSE_C, color="pink", x=100, y=20, orientation=180, ai=True)
car4 = Car("CAR4", 2, "CAR_ID_4", BLUE_C, color="blue", x=120, y=20, orientation=180, ai=False)
