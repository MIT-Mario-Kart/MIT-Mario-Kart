...
car1 = Car("CAR1", 1, "CAR_ID_2", GREEN_C, color="green", x=160, y=20, orientation=180, ai=False)
car2 = Car("CAR2", 2, "CAR_ID_1", BLUE_C, color="blue", x=140, y=20, orientation=180, ai=False)
